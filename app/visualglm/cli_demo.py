...
def main():
    ...
    parser.add_argument("--from_pretrained", type=str, default="/home/image_team/image_team_docker_home/lgd/e_commerce_lmm/weights/THUDM_Visualglm6b/", help='pretrained ckpt')
    # "/home/image_team/image_team_docker_home/lgd/e_commerce_lmm/weights/THUDM_Visualglm6b/"
    # /home/image_team/image_team_docker_home/lgd/e_commerce_lmm/results/visualglm_6b_xray/finetune-visualglm-6b-05-04-06-43/
    ...
    tokenizer = AutoTokenizer.from_pretrained("/home/image_team/image_team_docker_home/lgd/e_commerce_lmm/weights/visualglm-6b/", trust_remote_code=True)
    if not args.english:
