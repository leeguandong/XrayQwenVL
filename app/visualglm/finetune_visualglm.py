...
if __name__ == '__main__':
    ...
    if torch.cuda.is_available():
        model = model.to('cuda')
    # args.tokenizer_type == "/home/image_team/image_team_docker_home/lgd/e_commerce_lmm/weights/visualglm-6b/"
    tokenizer = get_tokenizer(args)
